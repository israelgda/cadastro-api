...
public class UsuarioDTO {
    ...
    @Pattern(regexp = "^[A-Z, a-z]{2}$", message = "UF deve ser informada com apenas 2 letras.")
    private String estado;

    @Pattern(regexp = "(\\d{3}.?\\d{3}.?\\d{3}-?\\d{2})", message = "O CPF deve conter 11 caracteres, apenas números.")
    private String cpf;
